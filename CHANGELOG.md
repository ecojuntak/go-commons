...
* add capabilites to change migration config ([1220f6c](https://github.com/ecojuntak/go-commons/commit/1220f6cc82f7a14a7ea6f0d9e981d536bad48c2b))
* add capability to create migration instance with MigrationTable config ([87aafc4](https://github.com/ecojuntak/go-commons/commit/87aafc4b71df42b56d81967192bcc9e4716a7be2))
* add check function for PipelineStatus ([d3f5d9e](https://github.com/ecojuntak/go-commons/commit/d3f5d9e26d10b882bc28c5ea3bf3c2209891f6e7))
* add configuration to setup semantic commit and github workflos ([9d10bed](https://github.com/ecojuntak/go-commons/commit/9d10bed173499fa5a3422c2f40eee011ff69c9a1))
* add Down function for migration ([f871cda](https://github.com/ecojuntak/go-commons/commit/f871cda1a20e04a136f733e5b661faabbc8b8892))
* add feature to Validate Template Result ([f6b97f4](https://github.com/ecojuntak/go-commons/commit/f6b97f4c55041592f6f03984e2010770bf540dbe))
* add fields parameter for zlog loggers ([2c2ae64](https://github.com/ecojuntak/go-commons/commit/2c2ae64982b79e5b41b33dc210c9d996f2dc28ff))
* add mock and fix test for git clone ([9d4937d](https://github.com/ecojuntak/go-commons/commit/9d4937da1de6e7cf062e008698bc4d0273c2af75))
* add mock package for cmd ([af1c7d8](https://github.com/ecojuntak/go-commons/commit/af1c7d8fc2700f165837efbff54d873a702a7acb))
* add NewNameWithBaseUrl for gitlab ([9d07974](https://github.com/ecojuntak/go-commons/commit/9d079748f6e94c027f126fcb1003183d6b2846df))
* add PipeToFile func ([8325c41](https://github.com/ecojuntak/go-commons/commit/8325c4178c7aa8038ebeb129ad0aa1c2f4d17fbd))
* add sudo when install apt-get ([d6b633e](https://github.com/ecojuntak/go-commons/commit/d6b633e9a6b5acf8278e926ebc4e58eae0e54aee))
* add Type alias for LogFields ([3e60c61](https://github.com/ecojuntak/go-commons/commit/3e60c616d30a975bf4c08c5b576f74020bfdaf96))
* add zerolog function to return event ([245809f](https://github.com/ecojuntak/go-commons/commit/245809f8ed56c4e8b92a0a4f3f299cf6c18a37e6))
* asynq logger ([409c804](https://github.com/ecojuntak/go-commons/commit/409c804888c37b0d749417a79f4f106b72ff3f5e))
* change how log behave on seeder function ([ad82315](https://github.com/ecojuntak/go-commons/commit/ad82315844bdcc866d9e4739e0191cf9bcf73705))
* change logging behaviour for seed ([813c7e7](https://github.com/ecojuntak/go-commons/commit/813c7e761490018c0b9b86e79daee0ffc719ea19))
* export var instead of struct ([c94a806](https://github.com/ecojuntak/go-commons/commit/c94a806a7dd670ea1dbfd1432dcb27c544c295a2))
* ignore feature for tmpl, with improvement ([10ab565](https://github.com/ecojuntak/go-commons/commit/10ab56545bfab212be84d7b5bc2b24ecbf816369))
* make sure github build run on vm ([483074c](https://github.com/ecojuntak/go-commons/commit/483074cf41cd55f1fa9325160d65cf915e77c3a1))
* modify README to trigger version update ([5dcbd32](https://github.com/ecojuntak/go-commons/commit/5dcbd32e2f135e5c5b7f8d540beafe39a8dab199))
* prevent nil error when check file.FileExists ([638da00](https://github.com/ecojuntak/go-commons/commit/638da00677c30722638acd4dd1e991ad2eaca9b2))
* refactor templ structure ([a1fd639](https://github.com/ecojuntak/go-commons/commit/a1fd639a008ea2d5339a127d0397ff5986277f01))
* remove unecessary sqlText on log ([5332b11](https://github.com/ecojuntak/go-commons/commit/5332b11d37de6612f4226db29daa67f17aafa9c2))
* remove wrong implementation of NewNameWithClient ([8e7e8b1](https://github.com/ecojuntak/go-commons/commit/8e7e8b136f28c762f13ec7ac0d1b676ce28ccbbd))
* return cmd object ([b8f7c4a](https://github.com/ecojuntak/go-commons/commit/b8f7c4a777dd8dbbcb869156f1e350fdaa89029a))
* update library ([199a965](https://github.com/ecojuntak/go-commons/commit/199a965be040ac7ee9da268770c74323549cf958))
* update library version, use official docker client ([ea92f24](https://github.com/ecojuntak/go-commons/commit/ea92f24f9b4b573e66912592653f6036d73edc72))
* upgrade library versions ([c69b089](https://github.com/ecojuntak/go-commons/commit/c69b0894ef2eae2b501db46a0b65e1cfa47b15e0))


### Features

* add clone function for git ([399ece3](https://github.com/ecojuntak/go-commons/commit/399ece3d89b52cccf1b076960cae386b8b90bd6b))
* add gitlab feature ([4a2fb25](https://github.com/ecojuntak/go-commons/commit/4a2fb25567ea821ec9df2254fe0246220477c5c4))
* add gitlab get group ([73357cd](https://github.com/ecojuntak/go-commons/commit/73357cd8c1faefe56ff43d87f49de4b82581e34b))
* add job helper for k8s ([45931a9](https://github.com/ecojuntak/go-commons/commit/45931a90fecea78db9a3e8562e6f70a11526dfcc))
* add jq and types pkg ([5b35042](https://github.com/ecojuntak/go-commons/commit/5b35042e0e89271677c39045d47c54c259f79fe1))
* add log for asynq, add missing fatal function ([3396cb3](https://github.com/ecojuntak/go-commons/commit/3396cb33a97c7369349a3bcb13414abc9f3739f4))
* add orm client for postgresql ([3f0b1eb](https://github.com/ecojuntak/go-commons/commit/3f0b1ebff2010fd806f4f8301b36b62eea41a3be))
* add seed functionality, add capabilities to scan template with custom delims ([dae9d01](https://github.com/ecojuntak/go-commons/commit/dae9d01b56a79e5c31fd95ee93edd27ebbe2cb0c))
* add zlog support for asynq ([25b81a6](https://github.com/ecojuntak/go-commons/commit/25b81a61fb89cfb3b138057e348c47e3256b5d8a))
* complete git pkg features ([5232d78](https://github.com/ecojuntak/go-commons/commit/5232d785edc62ab2dd7eec2256c3feae9a62b996))
* Refactor docker client, add deb and statsd helper ([3425434](https://github.com/ecojuntak/go-commons/commit/34254348aed126f4f2cfb33154e3fdde7567e101))
* revamp exec command, package renamed to cmd ([283dfcc](https://github.com/ecojuntak/go-commons/commit/283dfccb51c41899e60a7acba7107686d57b43d4))
* separate db migrate to mysql and postgresql ([72a667e](https://github.com/ecojuntak/go-commons/commit/72a667ebd1c42c3f1c0a8c2c3f0cf24403f6ecaf))
* separate docker test to local tag, to exclute those test on gitlab workflow ([4a01a26](https://github.com/ecojuntak/go-commons/commit/4a01a261bb6354131f30bb87e24894966ce4eea5))
* upgrade dependencies ([018c76a](https://github.com/ecojuntak/go-commons/commit/018c76a60a0ca2fa8dc0e3de8ac464d0d3b6fa2c))
